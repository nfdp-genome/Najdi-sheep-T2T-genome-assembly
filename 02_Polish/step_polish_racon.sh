#!/usr/bin/env bash
#SBATCH --job-name=step_polish_racon
...
ORIG_SCRIPT="${PIPELINE_ROOT}/scripts/step_polish_racon.sh"
...
print('log_file=' + shlex.quote(str(cfg.get('log_file','./logs/step_polish_racon.log'))))
PYEOF
)"
