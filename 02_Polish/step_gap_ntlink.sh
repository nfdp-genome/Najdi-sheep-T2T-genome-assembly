#!/usr/bin/env bash
#SBATCH --job-name=step_gap_ntlink
...
ORIG_SCRIPT="${PIPELINE_ROOT}/scripts/step_gap_ntlink.sh"
...
print('log_file=' + shlex.quote(str(cfg.get('log_file','./logs/step_gap_ntlink.log'))))
PYEOF
)"
