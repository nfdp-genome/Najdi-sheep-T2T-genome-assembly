#!/usr/bin/env bash
#SBATCH --job-name=step_gfa_primary
...
ORIG_SCRIPT="${PIPELINE_ROOT}/scripts/step_gfa_primary.sh"
...
print('log_file=' + shlex.quote(str(cfg.get('log_file','./logs/step_gfa_primary.log'))))
PYEOF
)"
