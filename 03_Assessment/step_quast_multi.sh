#!/usr/bin/env bash
#SBATCH --job-name=step_quast_multi
...
ORIG_SCRIPT="${PIPELINE_ROOT}/scripts/step_quast_multi.sh"
...
print('log_file=' + shlex.quote(str(cfg.get('log_file','./logs/step_quast_multi.log'))))
PYEOF
)"
